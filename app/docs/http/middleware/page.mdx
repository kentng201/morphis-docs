...
If the browser still reports that CORS is rejected, see [Troubleshooting](/docs/troubleshooting) for a quick diagnosis and the `router.use(Cors(...))` setup pattern.
